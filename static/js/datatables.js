...
exports.eejsBlock_timesliderScripts = function (hook_name, args, cb) {
  args.content = args.content + require('ep_etherpad-lite/node/eejs/').require("ep_tables/templates/datatablesScriptsTimeslider.ejs");
}
...
if (typeof (Datatables) == 'undefined') var Datatables = function () {
    ...
    var dt = {
      ...
      vars: {
        ...
        JS_KEY_CODE_BS: 8,
        JS_KEY_CODE_DEL: 46,
        TBL_OPTIONS: ['addTbl', 'addTblRowA', 'addTblRowB', 'addTblColL', 'addTblColR', 'delTbl', 'delTblRow', 'delTblCol', 'closeMenu']
      },
      /* passed parameters */
      context: null
    }; // end of dt
    ...
    /* Helper function. not meant to be used as a standalone function requires rowStartOffset */
    ...
    dt.doDatatableOptions = function (cmd, xByY) {
      ...
      if ((typeof (cmd) == 'object' && cmd.tblPropertyChange)) {
        ...
        case Datatables.vars.TBL_OPTIONS[7]:
          ...
          break;
        case Datatables.vars.TBL_OPTIONS[8]:
          break;          
        }
      }
    };
